package com.dkt.controller.${packageName}.${objectNameLower};
...
import com.dkt.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.dkt.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
