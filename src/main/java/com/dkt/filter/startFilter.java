...
import com.dkt.plugin.websocketInstantMsg.ChatServer;
import com.dkt.plugin.websocketOnline.OnlineChatServer;
import com.dkt.plugin.websocketVideo.VideoServer;
	...
	public void startWebsocketInstantMsg(){
		...
		try {
			...
			if(null != strWEBSOCKET && !"".equals(strWEBSOCKET)){
				String strIW[] = strWEBSOCKET.split(",shr,");
				if(strIW.length == 7){
