package com.dkt.dao.redis.impl;
...
import com.dkt.dao.AbstractBaseRedisDao;
import com.dkt.dao.redis.RedisDao;
import com.dkt.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.dkt.dao.redis.RedisDao#delete(java.lang.String)
	 */
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.dkt.dao.redis.RedisDao#delete(java.util.List)
	 */
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.dkt.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.dkt.dao.redis.RedisDao#get(java.lang.String)
	 */
