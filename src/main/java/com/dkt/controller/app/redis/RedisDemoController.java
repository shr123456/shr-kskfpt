package com.dkt.controller.app.redis;
...
public class RedisDemoController extends BaseController{
	...
	public Object redis(){
		...
		System.out.println(redisDaoImpl.addMap("dkt", jmap));				//存储Map
		System.out.println("获取Map:"+redisDaoImpl.getMap("dkt"));			//获取Map
		
		result += "获取Map:"+redisDaoImpl.getMap("dkt")+",";
