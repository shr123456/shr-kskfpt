package com.dkt.controller.information.pictures;
...
import com.dkt.service.information.pictures.PicturesManager;
...
public class PicturesController extends BaseController {
	...
	public Object save(
		...
		if(Jurisdiction.buttonJurisdiction(menuUrl, "add")){
			...
			pd.put("CREATETIME", Tools.date2Str(new Date()));	//@date
