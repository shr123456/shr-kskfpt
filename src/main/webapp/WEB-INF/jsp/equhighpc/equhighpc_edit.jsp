			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="equhighpc/${msg }.do" name="Form" id="Form" method="post">
							...
							<div id="zhongxin" style="padding-top: 13px;">
								<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><input type="text" name="LOOP_NAME" id="LOOP_NAME" value="${pd.LOOP_NAME}" maxlength="8" placeholder="这里输入回路名称" title="回路名称" style="width:98%;"/></td>
									</tr>
									<tr>
