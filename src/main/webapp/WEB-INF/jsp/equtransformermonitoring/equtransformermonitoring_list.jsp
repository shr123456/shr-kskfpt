			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 检索  -->
						<form action="equtransformermonitoring/list.do" method="post" name="Form" id="Form">
							<table style="margin-top:5px;">
								<tr>
									<td>
										<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入设备名称" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入设备名称"/>
...
<!-- basic scripts -->
	...
	<script type="text/javascript">
		...
		function show(ID,name,type){
			top.jzts();
			var url= '<%=basePath%>equtransformermonitoring/goShow.do?ID='+ID+'&name='+encodeURI(name)+'&type='+type;
			//alert(url);
