...
<body>
	...
	<%--<video width="100%" height="100%" autoplay="autoplay" loop="-1" style="position:absolute;bottom:0;right:0;left:0;top:0;z-index:1">--%>
	<video autoplay="autoplay" loop="-1" style="position: fixed;right: 0px;bottom: 0px;min-width: 100%;min-height: 100%;height: auto;width: auto;z-index:1">
		<source src="static/login/converted.mp4" type="video/mp4"/>
	</video>
	...
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
		...
		<div id="loginbox" >
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 广东可信电力股份有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 孙浩瑞 2100</span></font>
				</div>
			</div>
		</div>
		</div>
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',dkt,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
