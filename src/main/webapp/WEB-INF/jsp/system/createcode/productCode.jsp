					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.dkt.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td><input type="text" name="tabletop" id="tabletop" value="${msg == 'add' ? 'TB_' : ''}${fn:split(pd.TABLENAME, ',dkt,')[0]}" placeholder="这里输入表前缀" style="width:156px" title="表前缀"/></td>
							</tr>
						</table>
