...
<body class="no-skin">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-purple" title="自定义菜单" onclick="weixinMenu('${var.KEY_ID}');">
														自定义菜单
													</a>
													<c:if test="${QX.edit == 1 }">
	...
	<script type="text/javascript">
		...
		//去设置微信菜单页面
		function weixinMenu(KEY_ID){
			window.location.href='<%=basePath%>mymenu/goEditMenu.do?KEY_ID='+""+KEY_ID+"";
		}
