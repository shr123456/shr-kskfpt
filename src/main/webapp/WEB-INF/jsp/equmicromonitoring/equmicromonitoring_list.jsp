...
<div class="main-container" id="main-container">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="equmicromonitoring/list.do" method="post" name="Form" id="Form">
						<table style="margin-top:5px;">
							<tr>
								<td>
									<div class="nav-search">
										<span class="input-icon">
											<input type="text" placeholder="这里输入微机名称" class="nav-search-input" id="keywords" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入微机名称"/>
	...
	<script type="text/javascript">
		...
		function show(ID){
			top.jzts();
			var url= '<%=basePath%>equmicromonitoring/goShow.do?ID='+ID;
			//alert(url);
