		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="equmicroprotectiondevice/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="EQUIPMENT_NAME" id="EQUIPMENT_NAME" value="${pd.EQUIPMENT_NAME}" maxlength="100" placeholder="这里输入设备名称" title="设备名称" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">电源电压:</td>
								<td><input type="number" name="SUPPLY_VOLTAGE" id="SUPPLY_VOLTAGE" value="${pd.SUPPLY_VOLTAGE}" maxlength="32" placeholder="这里输入电源电压" title="电源电压" style="width:98%;"/></td>
							</tr>
							<tr>
