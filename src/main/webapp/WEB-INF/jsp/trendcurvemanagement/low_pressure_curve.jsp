...
<head>
    ...
    <script type="text/javascript">
        ...
        function  getEchartsList7(){
            ...
            $.ajax({
                url:"${path}/lowpressurecurve/findEchartsList.do",
                type:"post",
                dataType:"json",
                data:param,
        ...
        function showCustomerView() {
           ...
           //$("#Form").submit();
            var newid=$("#id").val();
            $.ajax({
                url:"${path}/lowpressurecurve/list.do",
                type:"post",
                dataType:"json",
                success: function (result){
                    var html="";
...
<div>
    ...
    <div class="cont">
        ...
        <div class="cont_dw power" id="echarts5"></div>
        <div class="cont_dw power" id="echarts6"></div>
    </div>
</div>
