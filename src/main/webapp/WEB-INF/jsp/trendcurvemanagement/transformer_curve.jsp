...
<head>
    ...
    <script type="text/javascript">
        ...
        function  getEchartsList7(){
            ...
            $.ajax({
                url:"${path}/transformer/findEchartsList.do",
                type:"post",
                dataType:"json",
                data:param,
...
<div>
    <div class="head">
        ...
        <div class="head_dw_zq">
            <div>
                <div>
                    ...
                    <div class="col-sm-3">
                        <select class="sel chosen-select form-control" name="select" id="select" style="background-color: #f5f5f5"  data-placeholder="请选择">
        ...
        <div class="head_dw sbxz">
            ...
            <input name="sbxz" id="sbxz" value="${equipmentName}" onclick="showCustomerView()"readonly>
        </div>
    ...
    <div class="cont">
        ...
        <div class="cont_up power" id="echarts3"></div>
    </div>
</div>
